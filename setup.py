...
setup(
    ...
    description='Modelos matemáticos',
    long_description=read("README.rst"),
    author='Rossember',
    author_email='rectmat555@hotmail.com',
    url='https://github.com/Rossember555',
    download_url='https://github.com/Rossember555/Sol/blob/main/setup.py'.format(
        VERSION),
    keywords=['Model Math'],
    install_requires=[
        'sympy',
